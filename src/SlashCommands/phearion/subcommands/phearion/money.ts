...
exports.default = new SlashCommand({
    ...
    run: async ({ interaction }) => {
        const user = (interaction as ExtendedInteraction).options.get('user')
            .value as string;
        ...
        await sql
            ...
            .then((res) => {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .addFields(
                        ...
                        {
                            name: '|Money <a:stevedance:879145932451639306>|   ',
                            value: ` **${money}** `,
                            inline: true,
                        },
                        {
            ...
            .catch(() => {
                interaction.reply({
                    content: `L'utilisateur Casper #${user} n'existe pas.`,
                    ephemeral: true,
                });
            });
    },
