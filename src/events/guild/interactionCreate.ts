...
import {
	...
	setTheme,
	setColor,
} from '../../SlashCommands/server/subcommands/welcome/src/setter/setCustom';
...
export default new Event('interactionCreate', async (client, interaction) => {
	...
	await command.run({
		...
		_args: (interaction as ExtendedInteraction).options as CommandInteractionOptionResolver,
		_client: client,
	});
});
